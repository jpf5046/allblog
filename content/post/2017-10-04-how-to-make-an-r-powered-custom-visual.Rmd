...
\center ![](/static/images/CommandLineAfterRvisualpromt.PNG) \center
...
It should look exactly like this:
  ...
  \center ![](/static/images/What the Packaged R Visual Looks like.PNG) \center
...
![](/static/images/Rscipt location.PNG)
...
![](/static/images/What the code looks like after changing R Script 4.PNG)
...
1. Go back to your command line an type `pbiviz package` -- you might have to type `ctrl+c` to terminate listening
  ...
  ![](/static/images/packageVisual.PNG)

2. Go to the same file you created in step two, there is going to be a new folder

  ![](/static/images/new fodler created after PACKAGE step.PNG)
